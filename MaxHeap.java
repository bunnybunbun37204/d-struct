public class MaxHeap {
    ...
    public static void main(String[] args) {
        // Create an instance of MaxHeap with a specified capacity
        MaxHeap maxHeap = new MaxHeap(10);

        int[] arr1 = {2, 7, 8, 10, 11, 3};

        // Use the buildHeap method to build the MaxHeap
        maxHeap.buildHeap(arr1, arr1.length);

        // Use the printHeap method to print the MaxHeap
        maxHeap.printHeap();
    }
}
